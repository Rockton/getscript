...
function loadpage() {
  function changecolor(){
   var header = document.querySelector('.styles__header___vR__R-camelCase');var blooketlogo = document.querySelector('styles__headerTextLeft___1IX-Y-camelCase');var pageheader = document.querySelector('.pageheader');var basictab = document.querySelector('.tab');var complextab = document.querySelectorAll('.tab')[1];var headervalue = localStorage.getItem('header');var textcolor = localStorage.getItem('text');pageheader.style.background=headervalue;basictab.style.color=textcolor;complextab.style.color=textcolor;if(header == null, undefined) {} else {header.style.backgroundColor=headervalue;blooketlogo.style.color=textcolor;}document.querySelector('.styles__listIcon___JvI1r-camelCase fas fa-play').style.color=textcolor;document.querySelector('.styles__listIcon___JvI1r-camelCase fas fa-compass').style.color=textcolor;document.querySelector('.styles__listIcon___JvI1r-camelCase fas fa-home').style.color=textcolor;document.querySelector('.styles__createIcon___3PIJb-camelCase fas fa-edit').style.color=textcolor;document.querySelector('.styles__statsIcon___1dLXo-camelCase').style.color=textcolor;document.querySelector('.styles__storeIcon___2h0yG-camelCase fas fa-store').style.color=textcolor;document.querySelector('.styles__listIcon___JvI1r-camelCase fas fa-suitcase').style.color=textcolor;document.querySelector('.styles__listIcon___JvI1r-camelCase fas fa-cog').style.color=textcolor;document.querySelector('.styles__logoutIcon___1hUNx-camelCase fas fa-sign-out-alt').style.color=textcolor;
};
  ...
  function loadicon() {
    var smallicon = document.createElement("div");document.body.appendChild(smallicon);smallicon.className='smallicon';smallicon.innerHTML='<i class="fas fa-chevron-circle-up" style="color:#fff;font-size:25px;"></i>';smallicon.onclick=function reopenpage(){loadpage();this.remove()};
  };
