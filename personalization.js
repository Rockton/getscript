...
// header: styles__header___vR__R-camelCase

// backgrounds: arts__mBody___-c4sd-camelCase arts__profileRegularBody___aCnfJ-camelCase arts__regularBody___3lHde-camelCase arts__body___3CJwS-camelCase

//whitedefault:

//blue default:

//whitetext: styles__joinButton___DgX1e-camelCase styles__signUpButton___34so5-camelCase styles__welcomeText___21OkA-camelCase styles__welcomeDesc___1eYgl-camelCase styles__welcomeButton____dqpb-camelCase styles__pronounceButton___3LHuY-camelCase styles__gameplayHeaderText___2SWxn-camelCase styles__gameplayText___18Hcx-camelCase styles__waitButton___86g7y-camelCase styles__finalText___2dP5e-camelCase styles__boringText___3ogT0-camelCase 

//blacktext: styles__loginButton___1jvQu-camelCase styles__sloganText___PINEl-camelCase styles__sloganDescText___1M97z-camelCase styles__blookHeaderText___1qmmu-camelCase styles__blookText___3zXaP-camelCase styles__howBigHeaderText___3oGE1-camelCase styles__howHeaderText___2DYAs-camelCase styles__howText___2oF5r-camelCase styles__featureHeaderText___1mEnY-camelCase styles__featureText___1KhN1-camelCase
function loadpage() {
function changecolor(){
  var header = document.querySelector('.styles__header___vR__R-camelCase');var blooketlogo = document.querySelector('.styles__headerTextLeft___1IX-Y-camelCase');var pageheader = document.querySelector('.pageheader');var basictab = document.querySelector('.tab');var complextab = document.querySelectorAll('.tab')[1];var headervalue = localStorage.getItem('header');var textcolor = localStorage.getItem('text');pageheader.style.background=headervalue;basictab.style.color=textcolor;complextab.style.color=textcolor;if(header == null, undefined) {} else {header.style.backgroundColor=headervalue;blooketlogo.style.color=textcolor;}document.querySelector('.fa-play').style.color=textcolor;document.querySelector('.fa-compass').style.color=textcolor;document.querySelector('.fa-home').style.color=textcolor;document.querySelector('.styles__createIcon___3PIJb-camelCase').style.color=textcolor;document.querySelector('.styles__statsIcon___1dLXo-camelCase').style.color=textcolor;document.querySelector('.styles__storeIcon___2h0yG-camelCase').style.color=textcolor;document.querySelector('.fa-suitcase').style.color=textcolor;document.querySelector('.fa-cog').style.color=textcolor;document.querySelector('.styles__logoutIcon___1hUNx-camelCase').style.color=textcolor;
};
  ...
  function loadicon() {
    document.body.style.overflow='auto';var smallicon = document.createElement("div");document.body.appendChild(smallicon);smallicon.className='smallicon';smallicon.innerHTML='<i class="fas fa-chevron-circle-up" style="color:#fff;font-size:25px;"></i>';smallicon.onclick=function reopenpage(){loadpage();this.remove()};
  };
...
function loadcomplex() {
  ...
  var sendbutton = document.createElement("div");pagerest.appendChild(sendbutton);sendbutton.className='sendbutton';sendbutton.innerHTML='Send!';sendbutton.onclick = function sendvalues() {var gethvalue = hexarea1.value;var gettvalue = hexarea2.value;if (gethvalue == '') {} else {localStorage.setItem('header', gethvalue)};if (gettvalue == '') {} else {localStorage.setItem('text', gettvalue)};changecolor();
  }
}
function changecolor(){
  var header = document.querySelector('.styles__header___vR__R-camelCase');var blooketlogo = document.querySelector('.styles__headerTextLeft___1IX-Y-camelCase');var pageheader = document.querySelector('.pageheader');var basictab = document.querySelector('.tab');var complextab = document.querySelectorAll('.tab')[1];var headervalue = localStorage.getItem('header');var textcolor = localStorage.getItem('text');pageheader.style.background=headervalue;basictab.style.color=textcolor;complextab.style.color=textcolor;if(header == null, undefined) {} else {header.style.backgroundColor=headervalue;blooketlogo.style.color=textcolor;}document.querySelectorAll('.styles__listIcon___JvI1r-camelCase')[0].style.color=textcolor;document.querySelectorAll('.styles__listIcon___JvI1r-camelCase')[1].style.color=textcolor;document.querySelectorAll('.styles__listIcon___JvI1r-camelCase')[2].style.color=textcolor;document.querySelector('.styles__createIcon___3PIJb-camelCase').style.color=textcolor;document.querySelector('.styles__statsIcon___1dLXo-camelCase').style.color=textcolor;document.querySelector('.styles__storeIcon___2h0yG-camelCase').style.color=textcolor;document.querySelectorAll('.styles__listIcon___JvI1r-camelCase')[3].style.color=textcolor;document.querySelectorAll('.styles__listIcon___JvI1r-camelCase')[4].style.color=textcolor;document.querySelector('.styles__logoutIcon___1hUNx-camelCase').style.color=textcolor;
};
window.
